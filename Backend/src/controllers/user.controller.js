...
const getResponse = asyncHandler(async (req, res) => {
    ...
    // For now, I’m mocking the response like you did:
    return res.status(200).json(
        new ApiResponse(
            ...
            { 
                ...
                //                👉 Look for a fertilizer with a ratio like 5-10-10 or 10-20-20.
                //                👉 You can also add bone meal (natural phosphorus source) or potash (potassium).
